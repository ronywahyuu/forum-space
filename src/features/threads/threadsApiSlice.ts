...
export interface ThreadsApiResponse extends ApiResponse<{ threads: Thread[] }> {}

export interface ThreadDetailsApiResponse extends ApiResponse<{ detailThread: Thread }> {}
